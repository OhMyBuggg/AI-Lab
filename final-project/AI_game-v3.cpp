...
int heuristic(int x, int y, const vector<vector<int > > &map){
    ...
    if(y==7)f--;
    else if(map[x][y+1]==0)f++;
    else if(map[x][y+1]==ene)f+=2;
	else if(map[x][y+1]==nowself)f--;
    ...
    if(x==7)f--;
    else if(map[x+1][y]==0)f++;
    else if(map[x+1][y]==ene)f+=2;
	else if(map[x+1][y]==nowself)f--;
